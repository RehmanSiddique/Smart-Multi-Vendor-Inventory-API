...
class Command(BaseCommand):
    help = 'Add sample suppliers with unique names'
    ...
    def handle(self, *args, **options):
        ...
        suppliers_data = [
            {
                'name': f'TechParts Solutions {suffix}',
            ...
            {
                'name': f'Office Depot Pro {suffix}',
            ...
            {
                'name': f'Global Manufacturing Inc {suffix}',
            ...
            {
                'name': f'Local Supplies Co {suffix}',
        ...
        for supplier_data in suppliers_data:
            try:
                ...
                self.stdout.write(f"Failed to create {supplier_data['name']}: {e}")
