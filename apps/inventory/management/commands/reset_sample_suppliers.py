...
class Command(BaseCommand):
    help = 'Clear existing suppliers and add sample suppliers'
    ...
    def handle(self, *args, **options):
        ...
        # Clear existing suppliers for this vendor
        deleted_count = Supplier.objects.filter(vendor=vendor).count()
        Supplier.objects.filter(vendor=vendor).delete()
        self.stdout.write(f"Deleted {deleted_count} existing suppliers")
